...
$testPlan = Join-Path $projectRoot "test-plans\blazedemo-load-test.jmx"
$reportDir = Join-Path $projectRoot "reports\load-test"
...
Write-Host "Load Test finalizado com sucesso."
